...
def get_cifar_10_datasets(train_transform, test_transform, train_classes=(0, 1, 8, 9),
    ...
    whole_training_set = CustomCIFAR10(root=cifar_10_root, transform=train_transform, train=True, download=False)
...
def get_cifar_100_datasets(train_transform, test_transform, train_classes=range(80),
    ...
    # Init entire training set
    whole_training_set = CustomCIFAR100(root=cifar_100_root, transform=train_transform, train=True, download=False)
    ...
    # Get test set for all classes
    test_dataset = CustomCIFAR100(root=cifar_100_root, transform=test_transform, train=False, download=False)
